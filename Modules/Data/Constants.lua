...
Data.Aura = {
    ...
    HealthRegen = {
        ...
        [18232] = 162, -- Food
        [18233] = 162, -- Food
        [18234] = ((ECS.IsTbc or ECS.IsWotlk) and 720 or 358), -- Food
        [20798] = 3, -- Demon Skin
        [21149] = 17, -- Egg Nog
        [22731] = 358, -- Food
        [24800] = 358, -- Food
        [25660] = ((ECS.IsTbc or ECS.IsWotlk) and 720 or 425), -- Food
        [25695] = 358, -- Food
        ...
        [26260] = 735, -- Food
        [26401] = ((ECS.IsTbc or ECS.IsWotlk) and 720 or 425), -- Food
        [26472] = 268, -- Food
        [26474] = 37, -- Food
        [28616] = 597, -- Food
        [29008] = 358, -- Food
        ...
        [29073] = ((ECS.IsTbc or ECS.IsWotlk) and 720 or 530), -- Food
        [446713] = 538, -- Food
        [470362] = 358, -- Food
        [470369] = 232, -- Food
        [1225769] = 425, -- Food
    ...
    HealthRegenModifier = {
        ...
        [24705] = ((ECS.IsTbc or ECS.IsWotlk) and nil or 0.25), -- Invocation of the Wickerman
    ...
    PercentageHealthRegen = {
        ...
        [1908] = ((ECS.IsTbc or ECS.IsWotlk) and 1/0.5 or 1/3)*5, -- Uber Heal Over Time
        ...
        [18790] = ((ECS.IsTbc or ECS.IsWotlk) and 0.02 or 0.03)/4*5, -- Fel Stamina
        ...
        [28176] = (ECS.IsWotlk and 0.02/5*5 or nil), -- Fel Armor
        [28176] = (ECS.IsWotlk and 0.02/5*5 or nil), -- Fel Armor
        [28189] = (ECS.IsWotlk and 0.02/5*5 or nil), -- Fel Armor
        ...
        [47892] = 0.02/5*5, -- Fel Armor
        [47893] = 0.02/5*5, -- Fel Armor
